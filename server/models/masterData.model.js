...
const TABLE_COLUMNS = {
  ...
  gram_panchayats: ['client_id', 'circle_id', 'taluka_id', 'name', 'code'],
  villages: ['client_id', 'gram_panchayat_id', 'taluka_id', 'name', 'code'],
  ...
  types_of_units: ['client_id', 'unit_id', 'name', 'code', 'type_category'],
